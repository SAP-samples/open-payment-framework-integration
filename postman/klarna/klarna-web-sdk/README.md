## Introduction ##
The   Postman Collection enables the integration of Klarna for payment processing through open payment framework(OPF).
...
c) Preparing  [Postman Environment](environment_configuration.json) file so the collection can be imported with all your OPF Tenant and Klarna test account unique values. 
...
## Preparing  Postman Environment Variables For your  OPF
...
And map follow values for Postman environment :
