## Introduction ##
The  Bruno Collection enables the integration of Adyen Component for payment processing through open payment framework(OPF).
...
d) Preparing  Bruno Environment Variables  so the collection can be imported with all your OPF tenant and Adyen test account unique values. 

e) Payment methods supported in OPF.

f) The language support in the Adyen Component.
...
| mode                                         | ``test``                                                                                                                                                                                                                                                                                                                                                                                                                 |
| sdkVersion                                   | ``6.22.0``  better to use newlest verison                                                                                                                                                                                                                                                                                                                                                                                |
...
| applePay**                                   | These parameters are for the OPF Quick Buy function. If you prefer to use the ApplePay express checkout within the Adyen Web Component, please leave these items unchanged and ensure they are unselected in your Postman collection.                                                                                                                                                                                                    |
